...
class RewardExchangeAnimationViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // 이미지 설정
        let moneyImageView = UIImageView(image: UIImage(named: "rewardExchange"))
        ...
        // 텍스트 레이블 설정
        sendingMoneyLabel.text = "돈 보내는 중..."
